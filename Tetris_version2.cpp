...
void Tetris::Welocme() // 欢迎界面
{
	...
	while (1)
	{
		...
		cout << "	↑ - Tourner" << endl;
		cout << "	↓ - Descendre rapidement" << endl;
		cout << "	← - Déplacer à gauche" << endl;
		cout << "	→ - Déplacer à droite" << endl;
		cout << "	Espace - Pause" << endl;
		cout << "■■■■■■■■■■■■■■■■■■■■■" << endl;
		cout << "■ Appuyez sur 1 à 3 pour choisir la difficulté■" << endl;
		SetPos(20, 10);
		x = getchar();
		if (x <= '9' && x >= '0')
		{
...
void Tetris::DrawMap() // 画游戏时界面
{
	...
	Input_score();
	SetPos(30, 21);
	cout << "Niveau de difficulté :: " << rank;
	SetPos(32, 2);
	cout << "Prochaine forme";
}
